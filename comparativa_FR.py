...
ciclos_FR = glob("FRes_300kHz/**/*ciclo_promedio_H_M.txt",recursive=True)
ciclos_FR.sort()
conc_FR =  20 #g/L
...
print('-'*50)    
#%% ploteo ciclos 
idc=[1.4,1.5,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7,7.5,8,8.5,9,9.5,10,10.5,11,11.5,12,12.5,13,13.5,14,14.5,15]
...
plt.suptitle(f'Comparativa ciclos promedio Ferroresinas \n300 kHz  [57; 6.5] kA/m')
