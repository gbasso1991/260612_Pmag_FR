...
ciclos_Pmag = glob("Pmag_300kHz/**/*ciclo_promedio_H_M.txt",recursive=True)
# resultados_Pmag = glob("Pmag_300kHz/**/*resultados.txt",recursive=True)

ciclos_Pmag.sort()
conc_Pmag =  20 #g/L

for p in ciclos_Pmag:
    print('  ',p)
print('-'*50)
# for res in resultados_Pmag:
# resultados_Pmag.sort()
#     print('  ',res)
# print('-'*50)    
#%% ploteo ciclos 
idc=[15.0,14.0,13.0,12.0,11.0,10.0,9.0,7.9,7.0,6.0,5.0,3.9,2.9,2.0]
...
for i,e in enumerate(ciclos_Pmag):
    _,_,_, H_Pmag,M_Pmag,_ = lector_ciclos(ciclos_Pmag[i])
    ax.plot(H_Pmag/1000,M_Pmag,'-',label=f'{H0[i]:.1f}')
...
plt.suptitle(f'Comparativa ciclos promedio Paramagneto \n300 kHz  [58; 8] kA/m')
plt.savefig('0_ciclos_promedio_Pm_300kHz.png',dpi=300)
